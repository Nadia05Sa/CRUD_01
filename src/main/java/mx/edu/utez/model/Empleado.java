...
import java.sql.Date;
 ...
 public class Empleado {
    ...
    public Date getFecha_Contratacion() {return Fecha_Contratacion;}

    public void setFecha_Contratacion(Date fecha_Contratacion) {Fecha_Contratacion = fecha_Contratacion;}
